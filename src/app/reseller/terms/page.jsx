  ...
  return (
    <div className='bg-white min-h-screen'>
      <div className='container mx-auto px-4 py-12'>
        <h1 className='text-2xl md:text-3xl font-bold text-center'>Reseller Terms & Conditions</h1>
        <p className='text-gray-600 text-center mt-2 mb-8'>
          Before proceeding with your registration, please review and accept the following
          conditions to join our platform as a reseller:
        </p>
          ...
          <CardContent className='p-6 space-y-6'>
            {policies.map((p, i) => (
              <div key={i} className='flex items-start gap-3'>
                <div className='mt-1'><CheckCircle2 className='h-5 w-5 text-emerald-600' /></div>
                <div>
            ...
            <div className='flex justify-end'>
              <Button
                ...
                disabled={!accepted}
                onClick={() => router.push('/auth/signup?type=reseller')}
              >
                Accept & Continue
              </Button>
            </div>
